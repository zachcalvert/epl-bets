...
## Concept: "EPL Bets" — EPL Betting Demo
...
### Phases 7–11: Launch & Growth (see `docs/LAUNCH-PLAN.md`)
- Phase 7: Community files + pytest scaffold + repo-wide automated suite complete (111 tests, 97.52% full-source, fail_under 95)
- Phase 8: CI/CD (GitHub Actions with ruff + pytest + Codecov)
- Phase 9: Deploy to fly.io, publish to GitHub
- Phase 10: Production hardening, observability, performance review
- Phase 11: Homepage leaderboard with top 10 balances and 30-second HTMX refresh
- Phase 12: Transparency features and "Under the Hood" panels shipped across Dashboard, Match Detail, and Odds Board
...
- **"Under the Hood" panels** — collapsible live event surfaces on key pages showing what just happened (HTMX refreshes, Celery work, WebSocket pushes, betting lifecycle updates)
